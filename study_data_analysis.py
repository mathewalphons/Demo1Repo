...
print("Maximum Employment Countries", "/n")
print(max_country, max_value)

# 2- Calculate Overall Completion Rate#######
...
print("Overall Completion Rate", "/n")
overall_completion_rate = overall_completion_rate(female_completion, male_completion)
for i in range(countries.size):
    print(countries[i], overall_completion_rate[i])
